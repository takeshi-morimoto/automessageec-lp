...
<div class="max-w-5xl bg-white bg-opacity-90 p-8 md:p-10 rounded-lg shadow-lg">
<h1 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight">ECショップの注文処理を<span class="text-primary">自動化</span></h1>
<p class="text-2xl md:text-3xl text-gray-700 mb-10">ハンドメイドマーケットの注文管理をもっと簡単に</p>
<p class="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">Gmail連携による自動メール取得、お客様へのサンクスメールなどの自動送信で、ECショップの運営効率を大幅に向上させます。</p>
<div class="flex justify-start">
<a href="#contact" class="bg-primary text-white px-10 py-4 text-lg rounded-button shadow-md hover:bg-blue-600 transition-colors text-center whitespace-nowrap">今すぐお問い合わせ</a>
</div>
</div>
</div>
</section>
...
<p class="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">AutoMessageECは、ECショップ運営者の作業負担を軽減するための機能を多数搭載しています。</p>
</div>
...
<h3 class="text-2xl font-semibold text-gray-900 mb-6 text-center">Gmail連携による自動メール取得</h3>
<p class="text-lg text-gray-600 text-center leading-relaxed">注文通知メールを自動的に取得し、必要な情報を抽出します。IMAP対応で安全かつ効率的に処理します。</p>
</div>
<!-- 機能2 -->
<div class="bg-white p-8 rounded-lg shadow-md transition-all duration-300 feature-card">
<div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto">
...
<h3 class="text-2xl font-semibold text-gray-900 mb-6 text-center">サンクスメールの自動送信</h3>
<p class="text-lg text-gray-600 text-center leading-relaxed">あらかじめ設定したテンプレートを使用して、お客様へサンクスメールを自動送信。丁寧な対応で顧客満足度を向上させます。</p>
</div>
<!-- 機能3 -->
<div class="bg-white p-8 rounded-lg shadow-md transition-all duration-300 feature-card">
<div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto">
...
<h3 class="text-2xl font-semibold text-gray-900 mb-6 text-center">ノーコードで簡単設定</h3>
<p class="text-lg text-gray-600 text-center leading-relaxed">プログラミングの知識不要。直感的なGUIで簡単に設定でき、誰でも短時間で導入できます。</p>
</div>
</div>
</div>
</section>
...
<div class="md:w-1/2">
<h3 class="text-3xl font-semibold text-gray-900 mb-6">Gmail連携・IMAP取得</h3>
<ul class="space-y-6">
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
</div>
<p class="text-lg leading-relaxed">Gmailとの安全な連携によるメール取得</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
</div>
<p class="text-lg leading-relaxed">IMAP対応で様々なメールサーバーに対応可能</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
...
<p class="mt-8 text-lg text-gray-600 leading-relaxed">カスタマイズにより独自メールサーバー対応や複数条件抽出も可能です。</p>
</div>
</div>
</div>
<!-- タブ2: 注文情報抽出 -->
...
<p class="text-lg leading-relaxed">主要ハンドメイドマーケットの注文通知メールから必要情報を正確に抽出</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
...
<p class="text-lg leading-relaxed">主要ハンドメイドマーケットへの自動ログイン処理</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
...
<p class="text-lg leading-relaxed">複数のサンクスメールテンプレートを登録・管理</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
</div>
<p class="text-lg leading-relaxed">顧客名や商品名などの変数を自動挿入</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
...
<p class="text-xl opacity-90">主要ハンドメイドマーケット対応（1アカウント）</p>
</div>
<div class="p-8">
<div class="text-center mb-8">
<span class="text-5xl font-bold text-gray-900">¥110,000</span>
...
<p class="text-lg leading-relaxed">Gmail連携による注文メール自動取得</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
</div>
<p class="text-lg leading-relaxed">サンクスメールの自動送信</p>
</li>
<li class="flex items-start">
<div class="w-6 h-6 flex items-center justify-center text-primary mr-3 mt-1">
<i class="ri-check-line ri-lg"></i>
...
<p class="text-xl text-gray-700 font-medium">オプション</p>
<p class="text-lg text-gray-600 mt-3 leading-relaxed">標準対応以外のECプラットフォームを追加する場合は、1サイトにつき別途¥100,000（税込）</p>
</div>
...
<p class="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">AutoMessageECを導入することで得られる具体的なメリットをご紹介します。</p>
</div>
...
<p class="text-lg text-gray-600 leading-relaxed">注文確認から顧客へのメッセージ送信までの作業を自動化することで、1日あたり約1〜2時間の作業時間を削減できます。この時間を商品開発や他の業務に充てることができます。</p>
</div>
<!-- メリット2 -->
<div class="bg-gray-50 p-8 rounded-lg shadow-md">
<div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-6">
...
<p class="text-lg text-gray-600 leading-relaxed">テンプレート化された丁寧なメッセージを即時に送信することで、顧客満足度が向上します。人的ミスを減らし、一貫した高品質な対応を実現します。</p>
</div>
<!-- メリット3 -->
<div class="bg-gray-50 p-8 rounded-lg shadow-md">
<div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-6">
...
<p class="text-lg text-gray-600 leading-relaxed">深夜や外出中でも注文に対して迅速に対応できるため、顧客の待ち時間を最小限に抑えることができます。休日や繁忙期でも安定した対応が可能になります。</p>
</div>
<!-- メリット4 -->
<div class="bg-gray-50 p-8 rounded-lg shadow-md">
<div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-6">
...
<h3 class="text-2xl font-semibold text-gray-900 mb-6">簡単導入・操作</h3>
<p class="text-lg text-gray-600 leading-relaxed">プログラミングの知識がなくても、直感的なインターフェースで簡単に設定・操作できます。初期設定サポートも充実しているため、ITに詳しくない方でも安心して導入できます。</p>
</div>
</div>
</div>
</section>
